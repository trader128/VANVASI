...
enum SharedKeys {
    ...
    static let monkSessionUntilPreferenceEnabled = "monkSessionUntilPreferenceEnabled"
    static let monkSessionUntilPreferenceMinutes = "monkSessionUntilPreferenceMinutes"
    static let monkSessionUntilActive = "monkSessionUntilActive"
    static let monkSessionUntilTimestamp = "monkSessionUntilTimestamp"
    static let pendingMonkSessionEnded = "pendingMonkSessionEnded"
